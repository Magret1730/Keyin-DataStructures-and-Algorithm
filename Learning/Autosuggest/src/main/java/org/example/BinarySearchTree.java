...
public class BinarySearchTree {
    ...
    //   Left -> Root -> Right // It sorts out binary search tree
...
//    Left -> Right -> Root
    ...
    public BinaryNode getSuccessor(BinaryNode curr) {
        curr = curr.right;
    ...
    public BinaryNode delNode(BinaryNode root, int x) {
        ...
        if (root.value > x) {
            ...
            BinaryNode succ = getSuccessor(root);
